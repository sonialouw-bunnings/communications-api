using Communications.Application.Clients.Commands.CreateClient;
using Communications.UnitTests.Common;
using System.Threading;
using Xunit;

namespace Communications.UnitTests.Client.Commands.CreateClient
{
